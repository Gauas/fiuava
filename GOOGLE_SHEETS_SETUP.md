# Kết nối biểu mẫu GuavaFiber với Google Sheet và email
...
Ở bước cấp quyền, chấp nhận quyền gửi email. Biểu mẫu `/contact/` sẽ lưu dữ liệu vào Sheet và gửi một email tới `contact@guavafiber.website`; địa chỉ người gửi được đặt làm **Reply-To** để có thể trả lời trực tiếp.
...
- Gửi thử trang `/contact/`: dữ liệu xuất hiện trong sheet `Lien he` và hộp thư `contact@guavafiber.website` nhận được nội dung.
